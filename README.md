...
If you don't want to compile the code from source, you can simply download the ready-to-use application:
1. Go to the **[Releases Page](../../releases)** on GitHub.
2. Download the latest `ZenBar.exe` from the Assets section.
3. Place `ZenBar.exe` anywhere on your computer (e.g., `C:\Program Files\ZenBar\`).
4. Double-click to run it! (You can also configure it to run on startup directly from its Settings menu).

*Check out the [V1.0.0 Release Notes](RELEASE_NOTES.md) for details on our first major launch!*
